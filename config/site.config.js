...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'me@mrspidy.me',
  ...
  footer:
    'Powered by <a href="https://github.com/lyc8503/onedrive-cf-index-ng" target="_blank" rel="noopener noreferrer">OneDrive</a>. Made with ❤ by Spidy.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ["/" , '/Drive2'],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/MrXSpidy616',
    },
  ],
